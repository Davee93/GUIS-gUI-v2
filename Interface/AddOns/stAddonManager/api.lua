...
---------------------------------------------------------
API.pixelfont = {format('Interface\\AddOns\\%s\\media\\visitor.ttf', addon), 8, 'MONOCHROMEOUTLINE'}
API.normalfont = {format('Interface\\AddOns\\%s\\media\\font.ttf', addon), 13, 'THINOUTLINE'}
...
function API.CreateCheckBox(name, parent, width, height, point, onclick)
	...
	checkbox:SetUITemplate("radiobutton")
