...
cfg.afkspincamera = true -- custom afk spin cam.

-- End of config // Start of code for tweaks --------------------------------------------

if cfg.afkspincamera then
...
AFKPanel:SetUITemplate( "backdrop" )
AFKPanel:Hide()
...
AFKPanelTop:SetUITemplate( "backdrop" )
AFKPanelTop:SetFrameStrata("FULLSCREEN")
AFKPanelTop:Hide()

AFKPanelTop.Text = AFKPanelTop:CreateFontString( nil, "OVERLAY" )
AFKPanelTop.Text:SetPoint( "TOPLEFT", AFKPanelTop, "TOPLEFT", 15, -13 )
AFKPanelTop.Text:SetFont("Interface\\AddOns\\GUIS-gUI\\media\\fonts\\PT Sans Narrow Bold.ttf", 20, "OUTLINE" )
AFKPanelTop.Text:SetText( "|cFFFF7D0Ag|r|cFFFFBB00UI|r|cFFFFFFFF™|r |cFFFFFFFF2.0|r |cFF4488FFfor Cata|r" )

AFKPanelTop.Text2 = AFKPanelTop:CreateFontString( nil, "OVERLAY" )
AFKPanelTop.Text2:SetPoint( "TOPLEFT", AFKPanelTop, "TOPLEFT", 15, -35 )
AFKPanelTop.Text2:SetFont("Interface\\AddOns\\GUIS-gUI\\media\\fonts\\PT Sans Narrow Bold.ttf", 15, "OUTLINE" )
--AFKPanelTop.Text2:SetText( "..myname.." )

AFKPanelTop.ClockText = AFKPanelTop:CreateFontString( nil, "OVERLAY" )
AFKPanelTop.ClockText:SetPoint( "TOPRIGHT", AFKPanelTop, "TOPRIGHT", -15, -13 )
AFKPanelTop.ClockText:SetFont("Interface\\AddOns\\GUIS-gUI\\media\\fonts\\PT Sans Narrow Bold.ttf", 20, "OUTLINE" )
-- AFKPanelTop.ClockText:SetTextColor( 0.7, 0.7, 0.7 )

AFKPanelTop.DateText = AFKPanelTop:CreateFontString( nil, "OVERLAY" )
AFKPanelTop.DateText:SetPoint( "TOPRIGHT", AFKPanelTop, "TOPRIGHT", -15, -35 )
AFKPanelTop.DateText:SetFont("Interface\\AddOns\\GUIS-gUI\\media\\fonts\\PT Sans Narrow Bold.ttf", 15, "OUTLINE" )
-- AFKPanelTop.DateText:SetTextColor( 0.7, 0.7, 0.7 )

local AFKPanelToplogo = CreateFrame("Frame", nil, AFKPanelTop)
AFKPanelToplogo:SetPoint("CENTER", AFKPanelTop, "CENTER", 0, 0 )
AFKPanelToplogo:SetSize(150, 75)
local AFKPanelToplogo_tex = AFKPanelToplogo:CreateTexture(nil, "OVERLAY")
--AFKPanelToplogo_tex:SetTexture(C.media.wowlogo)
AFKPanelToplogo_tex:SetPoint("TOPLEFT", AFKPanelToplogo, "TOPLEFT", 2, -2)
AFKPanelToplogo_tex:SetPoint("BOTTOMRIGHT", AFKPanelToplogo, "BOTTOMRIGHT", -2, 2)
...
AFKPanelTop:SetScript( "OnUpdate", function( self, elapsed )
		...
		if( interval <= 0 ) then
			...
			--AFKPanelTop.DateText:SetText( format("%s", date( Start.."%a|r".." %d. %B" ) ) )
			interval = .5
		end
	end )
end
...
local texts = AFK_LIST
local interval = #texts

local AFKScrollFrame = CreateFrame( "ScrollingMessageFrame", "AFKScrollFrame", AFKPanel )
AFKScrollFrame:SetSize( AFKPanel:GetWidth(), AFKPanel:GetHeight() )
AFKScrollFrame:SetPoint( "CENTER", AFKPanel, "CENTER", 0, 60 )
AFKScrollFrame:SetFont("Interface\\AddOns\\GUIS-gUI\\media\\fonts\\PT Sans Narrow Bold.ttf", 20, "OUTLINE" )
AFKScrollFrame:SetShadowColor( 0, 0, 0, 0 )
AFKScrollFrame:SetFading( false )
AFKScrollFrame:SetFadeDuration( 0 )
AFKScrollFrame:SetTimeVisible( 1 )
AFKScrollFrame:SetMaxLines( 1 )
AFKScrollFrame:SetSpacing( 2 )
AFKScrollFrame:SetScript( "OnUpdate", function( self, time )
	interval = interval - ( time / 30 )
	for index, name in pairs( AFK_LIST ) do
		if( interval < index ) then
			AFKScrollFrame:AddMessage( AFK_LIST[index], 1, 1, 1)
			tremove( texts, index )
		end
	end
...
AFKPanel:SetScript( "OnShow", function( self ) UIFrameFadeIn( UIParent, .5, 1, 0 ) end )
AFKPanel:SetScript( "OnHide", function( self ) UIFrameFadeOut( UIParent, .5, 0, 1 ) end )
